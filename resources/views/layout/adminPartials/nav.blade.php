...
<div class = "row">
  <div class="col pl-1">
    <a class="mr-2 text-secondary cart" href="/Admin/AddManager">Add Manager</a>
    <a class="mr-2 text-secondary cart" href="#" data-toggle="modal" data-target="#serialModalCenter">Add Serial</a>
  <a class="mr-2 text-secondary cart" href="{{route('AdminProduct.addProduct')}}}}">Add Product</a>
  <a class = "mr-2 text-secondary profile" href="{{route('Login.index')}}"><i class="fa fa-user fa-lg"></i></a>
  <a class="text-secondary profile" href="/Logout/Index">Logout</a>
  </div>
</div>
